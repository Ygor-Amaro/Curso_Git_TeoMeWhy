...
Curso do professor Teo Calvo (escola TeoMeWhy), sobre versionamento de código e repositórios remotos com Git, Github, Gitflow + VSCode.
para mais acesse: [TeoMeWhy](https://cursos.teomewhy.org/)
